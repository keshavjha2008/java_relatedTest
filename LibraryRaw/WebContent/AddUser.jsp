	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				...
				<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
				<div id="page-title">
					<h1 class="page-header text-overflow">Add New User</h1>
						...
						<div class="col-lg-12">
							...
							<div class="tab-base">
								...
								<ul class="nav nav-tabs">
									<li class="active"><a href="#demo-bsc-tab-1" data-toggle="tab"><i class="fa"></i> Account</a></li>
									<li><a href="#demo-bsc-tab-2" data-toggle="tab"><i class="fa"></i> Information</a></li>
								</ul>
					
								<!-- Tabs Content -->
								<form id="demo-bv-bsc-tabs" class="form-horizontal" action="AddUser.kmj" method="post">
									<div class="tab-content">
										<div class="tab-pane pad-btm fade in active" id="demo-bsc-tab-1">
											<h4 class="text-thin mar-btm">Provide Account Details</h4>
											<hr>
											<div class="form-group">
													<label class="col-lg-3 control-label">USN</label>
													<div class="col-lg-4">
														<input type="text" class="form-control" name="username" placeholder="USN">
													</div>
											</div>
													<div class="form-group">
												...
												<div class="col-lg-4">
													<div class="radio">
														<label class="form-radio form-icon">
															<input type="radio" name="memberType" value="1"> Student
														</label>
					
														<label class="form-radio form-icon">
															<input type="radio" name="memberType" value="2"> Professor
														</label>
										...
										<div class="tab-pane fade" id="demo-bsc-tab-2">
											<h4 class="mar-btm text-thin">Provide personal Information</h4>
											<hr>
											<div class="form-group">
